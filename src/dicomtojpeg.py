...
SAVEDIR = '/home/vishy/Desktop/Myfiles/Kaggle/RSNA_PE/inputs/train-jpegs/'
MAX_LENGTH = 512.
...
dicom_folders = list(('/media/vishy/hdd1/Kaggle/RSNA/rsna_dicom/sample_train/' + df.StudyInstanceUID + '/'+ df.SeriesInstanceUID).unique())
dset = Lungs(dicom_folders)
loader = DataLoader(dset, batch_size=1, shuffle=False, num_workers=6, collate_fn=lambda x: x)
